...
CREATE TABLE SALESAPP.PROFILE_THEMES (
    ...
    TITLE_TEXT_COLOR VARCHAR2(7)   DEFAULT '#111111',
    FORM_TEXT_COLOR  VARCHAR2(7)   DEFAULT '#444444',
    MENU_TEXT_COLOR  VARCHAR2(7)   DEFAULT '#FFFFFF',
...
-- ---------------------------------------------------------------------------
-- MIGRATION v2: añadir columnas de texto tipográfico a PROFILE_THEMES
-- Ejecutar sólo si la tabla ya existe en producción (creación nueva ya las incluye)
-- ---------------------------------------------------------------------------
ALTER TABLE SALESAPP.PROFILE_THEMES ADD (TITLE_TEXT_COLOR VARCHAR2(7) DEFAULT '#111111');
ALTER TABLE SALESAPP.PROFILE_THEMES ADD (FORM_TEXT_COLOR  VARCHAR2(7) DEFAULT '#444444');
ALTER TABLE SALESAPP.PROFILE_THEMES ADD (MENU_TEXT_COLOR  VARCHAR2(7) DEFAULT '#FFFFFF');

COMMENT ON COLUMN SALESAPP.PROFILE_THEMES.TITLE_TEXT_COLOR IS 'Color del texto de títulos/encabezados';
COMMENT ON COLUMN SALESAPP.PROFILE_THEMES.FORM_TEXT_COLOR  IS 'Color del texto en campos de formulario';
COMMENT ON COLUMN SALESAPP.PROFILE_THEMES.MENU_TEXT_COLOR  IS 'Color del texto en el menú de navegación';
